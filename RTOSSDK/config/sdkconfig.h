...
#define CONFIG_RTOS_HEAP_SIZE                  	    (4U * 1024U)
...
#define CONFIG_RTOS_USE_IWDG                        0 // Can't debug if turn on iwdg.
 ...
 */
#if defined(STM32F4)
#define CONFIG_FLASH_DATA_CACHE					 	0
#define CONFIG_FLASH_INSTRUCTION_CACHE         	 	0
#define CONFIG_FLASH_PREFETCH_MODE             	 	0
#endif /* STM32F4 */
#define CONFIG_USE_SDRAM                            0
/**
...
#define CONFIG_OVER_CLOCK                       	0 // Note: if over clock, your device maybe not work correctly
...
#define CONFIG_LOG_UART_NUM 						USART3

#define CONFIG_LOG_UART_TX 							10
#define CONFIG_LOG_UART_TXP 						GPIOB
#define CONFIG_LOG_UART_RX 							11
#define CONFIG_LOG_UART_RXP 						GPIOB
#endif /* LOG_UART */
