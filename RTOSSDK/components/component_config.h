...
#define ENABLE_COMPONENT_SPIFLASH       1

#define ENABLE_COMPONENT_SX127X_LORA    0

#define ENABLE_COMPONENT_TFTSPI         1

#define ENABLE_COMPONENT_GUIMENU        1

#define ENABLE_COMPONENT_PARSE_PACKET   0
#if ENABLE_COMPONENT_PARSE_PACKET
#define ENABLE_COMPONENT_PARSE_PACKET_DEBUG 1
#endif /* ENABLE_COMPONENT_PARSE_PACKET */

#define ENABLE_COMPONENT_WIFIIF         0
